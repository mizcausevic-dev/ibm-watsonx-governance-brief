...
const PRODUCT = {
  "repo": "ibm-watsonx-governance-brief",
  "vendor": "IBM",
  "title": "watsonx governance brief",
  "domain": "AI Governance / Enterprise",
  "audience": "AI governance teams, enterprise architects, risk leaders, and modernization executives",
  "problem": "Enterprise AI decisions get stuck when model risk, mainframe context, workflow ownership, and governance evidence are not packaged together.",
  "workflow": "The product ties watsonx governance posture to controls, exception ownership, audit evidence, and modernization decision paths.",
  "business": "Leaders can decide where AI governance reduces exposure, where modernization saves money, and what story is safe for the board.",
  "technical": "Synthetic enterprise-AI lanes are scored deterministically and rendered as a static governance proof packet.",
  "integration": "IBM watsonx governance, mainframe workflows, model risk registers, controls, and exception evidence.",
  "keywords": [
    "IBM",
    "watsonx",
    "AI governance",
